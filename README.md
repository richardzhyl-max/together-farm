...
- 原创绿色 Q 版共同农场场景，不使用或复制第三方游戏素材。
- 游戏 HUD 集中展示金币、情侣值、农场名和 6 位邀请码。
- 2.5D 卡通泥土地带有层次、阴影和播种区域，不同成长进度会改变作物尺寸与状态效果。
- 宠物使用小屋展示栏，商城使用卡片式货架，留言板采用情侣小纸条视觉。
- 手机端优先设计，桌面端保持居中最大宽度布局。
